...
/*
  ...
  if (preferences.Config.Skin.XSuits == 1) {
    new_Skin.XSuits = 1405628;//金尊法老
//new_Skin.XSuits = 1406398;//涤焰魔甲套装
    new_Skin.Hair = 40605012;//双马尾
    
  }
  if (preferences.Config.Skin.XSuits == 2) {
    new_Skin.XSuits =  1405870;//血鸭ID: 1405909 | name: 血鸦圣装(5星)
//new_Skin.XSuits = 1407385;//顽皮恶魔套装1407385
    new_Skin.XSuits1 = 1403257;
    
  }
  if (preferences.Config.Skin.XSuits == 3) {
    new_Skin.XSuits = 1405983;//1405983//海王61405983//海王6
    new_Skin.Hair = 40605012;//双马尾
    //new_Skin.XSuits = 1407188;//小杰套装1407188
  }
  if (preferences.Config.Skin.XSuits == 4) {
    new_Skin.XSuits = 1406152;//寒冰6
    //new_Skin.XSuits = 1405205;//酷萌兔宝套装1405205
...
new_Skin.Hair = 40605012;//双马尾
  ...
  if (preferences.Config.Skin.XSuits == 5) {
    new_Skin.XSuits = 1406311;//精灵王6
//new_Skin.XSuits = 1406759;//数码酷熊套装 1406759
    //new_Skin.XSuits = 1410011; //Mặt nạ 1.403.414//金尊名流套装1405030
    
  }
  if (preferences.Config.Skin.XSuits == 6) {
    new_Skin.XSuits = 1406475;//1406475//金辉艳后圣装（6星）
    new_Skin.Hair = 40605012;//双马尾
   //new_Skin.XSuits = 1400106; //武装女仆套装1400106
  }
  if (preferences.Config.Skin.XSuits == 7) {
    new_Skin.XSuits = 1406713 ;//| name: 千面诡皇圣装（5星）
    new_Skin.Hair = 40605012;//双马尾
    //new_Skin.XSuits = 1405801;//B.Duck套装1405801
  }
  if (preferences.Config.Skin.XSuits == 8) {
    new_Skin.XSuits = 1406716;// | name: 千面诡皇圣装（5星）
    new_Skin.XSuits1 = 1410346; // khung
    //new_Skin.XSuits1 = 402133;
    //new_Skin.XSuits = 1406914;//水银战姬套装1403686//秘法使徒套装1406914
  }
  if (preferences.Config.Skin.XSuits == 9) {
    new_Skin.XSuits = 1406970;//ID: 1406970 | name: 秘渊灵主圣装(6星)
    new_Skin.XSuits1 = 402147;
    //new_Skin.Shoes = 4151006; //滑翔
//new_Skin.XSuits = 1406954;//比克角色（绿哥布林
  }
  if (preferences.Config.Skin.XSuits == 10) {
   new_Skin.XSuits = 1407102;//1407102 | name: 曙光芙洛拉圣装(6星)
    new_Skin.XSuits1 = 40604002;
    //new_Skin.Shoes = 4151006; //滑翔
//new_Skin.XSuits = 1407031;//KFC绝地上校（kfc老头
  }
   if (preferences.Config.Skin.XSuits == 11) {
...
if (preferences.Config.Skin.XSuits == 24) {
    new_Skin.XSuits =1406387 ;//明日香
//new_Skin.XSuits = 1400051;
    //new_Skin.Shorts = 1400052;
  }
if (preferences.Config.Skin.XSuits == 25) {
    new_Skin.XSuits = 1406389;//薰
  }
if (preferences.Config.Skin.XSuits == 26) {
    new_Skin.XSuits = 1405623;//冥界旅行者//裁决冥王套装1406569
//new_Skin.XSuits = 1406569;
  }
if (preferences.Config.Skin.XSuits == 27) {
    new_Skin.XSuits = 1406385;//eva 真嗣
  }
if (preferences.Config.Skin.XSuits == 28) {
    new_Skin.XSuits = 1405163;//废墟猎手
  }
if (preferences.Config.Skin.XSuits == 29) {
    new_Skin.XSuits = 1407079; //极乐愚者
  }
if (preferences.Config.Skin.XSuits == 30) {
    new_Skin.XSuits = 1407276; //神羽恋人女
//new_Skin.XSuits = 1405040;//性感胖达套装1405040
  }
if (preferences.Config.Skin.XSuits == 31) {
    new_Skin.XSuits = 1407225; //琉璃仙灵
  }
if (preferences.Config.Skin.XSuits == 32) {
    new_Skin.XSuits = 1407365; //风灵加尔7星//致命代码套装1406675
//new_Skin.XSuits = 1406675;
  }
if (preferences.Config.Skin.XSuits == 33) {
    new_Skin.XSuits = 1400569;//紫鲨鱼衣
    new_Skin.Shorts = 1400650;//紫鲨鱼裤子
    new_Skin.Shoes = 1400651;//紫鲨鱼鞋子
    new_Skin.Gloves = 452002;//冰霜手套
  }
if (preferences.Config.Skin.XSuits == 34) {
    new_Skin.XSuits = 1400101;//指挥官上衣
    new_Skin.Shorts = 1404397;//精美织物裤子
...
if (preferences.Config.Skin.XSuits == 65) {//////////2b。    65
    new_Skin.XSuits = 1407415; //2b
    new_Skin.Hair = 1410738;//2b
  }
if (preferences.Config.Skin.XSuits == 42) {
...
if (preferences.Config.Skin.XSuits == 44) {
    new_Skin.XSuits = 1407470; //烈焰古神 1407470
...
if (preferences.Config.Skin.XSuits == 56) {
    new_Skin.XSuits = 1407512; //ID: 1407512 | name: 幽冥阿努比斯圣装(7星)
  }
if (preferences.Config.Skin.XSuits == 57) {
    new_Skin.XSuits = 1407441; //ID: 1407441 | name: 糖心雪宝套装
  }
if (preferences.Config.Skin.XSuits == 58) {
    new_Skin.XSuits = 1407329; //ID: 1407329 | name: 霓虹天后套装
  }
if (preferences.Config.Skin.XSuits == 59) {
    new_Skin.XSuits = 1410610; //SPY套装
  }
if (preferences.Config.Skin.XSuits == 60) {
    new_Skin.XSuits = 1400687; //木乃伊//小黄鸭套装1405959
    //new_Skin.Shoes = 4151006; //滑翔
//new_Skin.XSuits = 1405959;
}
//青霜剑姬1407471 青霜剑姬头饰1410797
if (preferences.Config.Skin.XSuits == 61) {
    new_Skin.XSuits = 1407470; //
}
if (preferences.Config.Skin.XSuits == 62) {
    new_Skin.XSuits = 1407471; //
    new_Skin.Hair = 1410797;//
}
if (preferences.Config.Skin.XSuits == 63) {
    new_Skin.XSuits = 1407522; //SPY套装
}

if (preferences.Config.Skin.XSuits == 66) {
    new_Skin.XSuits = 1404049;//黄鲨鱼 衣
    new_Skin.Shorts = 1404050;//裤子
    new_Skin.Shoes = 1404423;//鞋子ID: 1404423 | name: 霹雳拳王鞋子
    new_Skin.Hair = 1410085;//大悲头
    new_Skin.Gloves = 452002;//冰霜手套
  }
if (preferences.Config.Skin.XSuits == 67) {
    new_Skin.XSuits = 1407572;//
  ...
  if (preferences.Config.Skin.XSuits == 68) {
    ...
    //new_Skin.Shoes = 1404423;//鞋子ID: 1404423 | name: 霹雳拳王鞋子
    new_Skin.Hair = 1400092;//
    //new_Skin.Hair = 1404198;//
  }
if (preferences.Config.Skin.XSuits == 69) {
    new_Skin.XSuits = 1404127;//
    new_Skin.Shorts = 1404441;//裤子
    //new_Skin.Shoes = 1404423;//
    new_Skin.Hair = 1410020;
  }
if (preferences.Config.Skin.XSuits == 70) {//假木乃伊
    new_Skin.XSuits = 1404243;//
    new_Skin.Shorts = 1404230;//裤子
    new_Skin.Shoes = 1404231;//
    new_Skin.Hair = 1403095;
    new_Skin.Gloves = 452001;//冰霜手套
...
if (preferences.Config.Skin.XSuits == 88) {//白鲨鱼
...
if (preferences.Config.Skin.XSuits == 89) {//ID: 1407558 | name: 曙光女帝套裝
    new_Skin.XSuits = 1407558;//
    }
if (preferences.Config.Skin.XSuits == 90) {//ID: 1407559 | name: 暗月至尊套裝
    new_Skin.XSuits = 1407559;//
    }
*/
////////////////////////////////////////////////////////
...
int m4v[] = { 101004, 1010042, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
int m4168[] = { 1010042, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
int m4169[] = { 1010043, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
int m4161[] = { 1010044, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
int m4162[] = { 1010045, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
int m4163[] = { 1010046, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
int m4164[] = { 1010047, 1101004046, 1101004062, 1101004078, 1101004086, 1101004098, 1101004138, 1101004163,1101004201,1101004209,1101004218,1101004226,11010044236
};
...
{
ImGui::Checkbox(("经典飞天(上飞机前)"), &据点);
ImGui::SameLine();
ImGui::Checkbox(("经典飞天(落地后)"), &无后座);
...
*/
                        ...
                        ImGui::EndTabItem();
                          ...
                          ImGui::Text(ICON_FA_TIMES"使用危险功能容易导致账号封禁");


ImGui::Spacing();
ImGui::Checkbox("越南过一秒", &越南过一秒);
ImGui::SameLine();
...
TNameEntryArray *GetGNames() {
    ...
    if([BundID containsString:@"imobile"]){
        return ((TNameEntryArray *(*)()) ((unsigned long)Get_module_base() +0x104256e0c))();//GNameFuns
    }
    return 0;
}
...
if(!localController->LineOfSightTo(localController->PlayerCameraManager, Player->GetBonePos("hand_l", {}), true))
{//左手
is左手 = false;
}else{
is左手 = true;
...
if(!localController->LineOfSightTo(localController->PlayerCameraManager, Player->GetBonePos("hand_r", {}), true))
{//右手
is右手 = false;
}else{
is右手 = true;
...
if(!localController->LineOfSightTo(localController->PlayerCameraManager, Player->GetBonePos("foot_l", {}), true))
{//左脚
is左脚 = false;
}else{
is左脚 = true;
...
if(!localController->LineOfSightTo(localController->PlayerCameraManager, Player->GetBonePos("foot_r", {}), true))
{//右脚
is右脚 = false;
}else{
is右脚 = true;
...
/*
if (有水印) {                
             std::wstring Sign = L"XM-MAX";//水印
tslFont->LegacyFontSize = 25;
 DrawOutlinedText(HUD, Sign, {(float) ScreenWidth / 2, 35}, 红色, COLOR_RED, true);//原2.15改1.15                 
            }
if (无水印) {                
...
//
/*
std::string fpsstr = "FPS当前帧数: " + std::to_string(static_cast<int>(std::round(FPS)));
...
auto Actors = getActors();
             ...
             actor != ingame.end(); actor++)
        {
            ...
            DrawSmallOutlinedText(HUD,s, FVector2D(screenWidth/2.1-650, 550), COLOR_WHITE, {0,0,0,1}, false);
...
int 命中数量 = ZdMax * 子追命中率;
 ...
 /*if (子弹信息) {
    ...
    DrawFilledRect1(HUD, {600, 700}, 15, (CurHP * 130 / MaxHP));

    DrawRectangle(HUD, {600, 570}, 15, 130, 1.0f, {1.f, 1.f, 1.f, 1.f});

        }
    }
 }         
if(Config.ESPMenu.Weapon && IsLogin){
            auto WeaponManagerComponent = localPlayer->WeaponManagerComponent;
              if (WeaponManagerComponent) {
                    auto CurrentWeaponReplicated = (ASTExtraShootWeapon *) WeaponManagerComponent->CurrentWeaponReplicated;//指针指向类名ASTExtraShootWeapon
                    if (CurrentWeaponReplicated) {
...
std::to_wstring((int)ZdDq);
                     
                        DrawOutlinedText(HUD, sb, {(float) glWidth / 2-200, (float) glHeight-300}, COLOR_YELLOW, COLOR_BLACK, true);
...
if (射线) {
                            if (Player->bEnsure) {
                            DrawLine(HUD, {(float)ScreenWidth / 2, 8}, FVector2D(HeadSc.X, HeadSc.Y - 50), 1.0f, COLOR_WHITE);
                            } else {
                            DrawLine(HUD, {(float)ScreenWidth / 2, 8}, FVector2D(HeadSc.X, HeadSc.Y - 50), 1.0f, visCol);
                            }
					    }
...
//                                                                        int MaxHP = (int) Player->HealthMax;
                                    ...
                                    if (gGameplayStatics->ProjectWorldToScreen(localPlayerController, AboveHead, false, &AboveHeadSc)) {
                                        ...
                                        if(Player->bEnsure){
                                            DrawFilledRectangle(HUD, {AboveHeadSc.X, AboveHeadSc.Y}, (CurHP * mWidth / MaxHP), mHeight, COLOR_GREEN);
...
DrawOutlinedText(HUD, FString(Text), FVector2D(RootSc.X - 13, (HeadSc.Y - 21)), COLOR_WHITE, COLOR_BLACK, true);
                                        ...
                                        if (Config.ESPMenu.Distance  && IsLogin){
